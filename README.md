...
<p align="center">
  <img src="fig/原始DEM数据生成的地形文件.png" width="600" alt="原始 DEM 生成效果">
</p>
<p align="center"><em>原始 DEM 直接建模时的边缘伪影</em></p>

<p align="center">
  <img src="fig/DEM数据预处理后生成的地形文件.png" width="600" alt="DEM 预处理后生成效果">
</p>
<p align="center"><em>预处理后的 DEM 建模效果</em></p>
...
<p align="center">
  <img src="fig/PathB的支护桩建模效果.png" width="700" alt="Path B 支护桩建模效果">
</p>
<p align="center"><em>Path B：地质体 + 实体支护桩体网格建模</em></p>

<p align="center">
  <img src="fig/PathB的支护桩建模效果2.png" width="700" alt="Path B 支护桩建模效果 2">
</p>
<p align="center"><em>Path B：支护桩与地质体融合后的 FLAC3D 导入结果</em></p>
...
<p align="center"><em>自动分层与材料赋值示意</em></p>

<p align="center">
  <img src="fig/精细化建模示意图.png" width="600" alt="FOS 结果示意图">
</p>
<p align="center"><em>安全系数分析结果示意</em></p>

<p align="center">
  <img src="fig/随机场模拟示意图.png" width="600" alt="随机场模拟示意图">
</p>
<p align="center"><em>可靠度分析中的随机场示意</em></p>
...
- [docs/structure_schema_spec.md](file:///d:/2026.03%20FLAC3D%20Code-Native/docs/structure_schema_spec.md)
